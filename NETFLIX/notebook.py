...
# Create a list of average movie lengths
durations = [103, 101, 99, 100, 100, 95, 95, 96, 93, 90]

# Create a dictionary with "years" and "durations" as keys and the lists as values
...
# Create a line plot of the data using the "years" and "durations" columns of durations_df
